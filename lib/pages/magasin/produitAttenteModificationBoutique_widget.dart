...
class ContProduitBoutiqueAttenteModificationBoutique extends StatefulWidget {
  ...
  @override
  State<ContProduitBoutiqueAttenteModificationBoutique> createState() =>
      _ContProduitBoutiqueAttenteModificationBoutiqueState();
}

class _ContProduitBoutiqueAttenteModificationBoutiqueState
    extends State<ContProduitBoutiqueAttenteModificationBoutique> {
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        Icon(Icons.edit, color: Color(0x55BE4A00)),
                        SizedBox(width: larg(context, ratio: 0.025)),

                        /*h7(
                          context,
                          texte: "En traitement... bdhghufuiehfu",
                          couleur: Color(0xFFBE4A00),
                        )*/
                        TexteClignotant(texte: "A Modifier.."),
                      ],
                    ),
                    h8(
                      context,
